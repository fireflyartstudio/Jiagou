...
(function() {
    ...
    {
        $.get(window.defs.siteUrl + 'latest_version', function(data) {
...
(function() {
    ...
    window.getCommandLine = function(params, asArrays) {
        ...
        var ret = '"' + window.defs.pixelator_command + '"' + " \"_srcFile_\" \"_destFile_\" --pixelate _pixelate_ --colors _colors_ --palette_mode _palette_ --enhance _enhance_ --smooth _smooth_ --smooth_iterations _smoothIter_ --refine_edges _opacityThresh_ --stroke _stroke_ --stroke_opacity _strokeOpacity_ --stroke_on_colors_diff _strokeOnColors_ --background _background_ _resize_ _diagonalStroke_ _paletteStroke_ --palette_file \"_paletteFile_\"";
    ...
    window.resetProjectSettings = function() {
        setProjectSettingsFromDict(window._projectDefaults);
        setSourcePath("");
        setPalettePath("");
    }
